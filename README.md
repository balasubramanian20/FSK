...
```
### Output Waveform
![download](https://github.com/user-attachments/assets/cb634cb8-dea8-4335-b735-62010e48f6a7)


### Results
Frequency Shift Keying (FSK) will be displayed in separate plots. Thus implemented using python colab.
